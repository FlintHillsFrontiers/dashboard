...
function drawEducationChart(data){
  ...
  //Create the y scale and set the range
  var y = d3.scale.linear()
    .rangeRound([h-marginBottom, marginTop]);
  
 //Create the x scale and set the range
  ...
  x.domain(d3.extent(data, function(d) { return d.Year; }));
   ...
   //Set the x domain
    ...
    svg.selectAll(".y.axis").append("text")
        ...
        .text("Percent of population 25+ with Bachelor's degree and above");
  ...
  //Create the legend div
    ...
    document.getElementById('education').appendChild(legendDiv);
  ...
  function showPopover (d) {
    $(this).popover({
      ...
      html : true,
      content: function() { 
        return "Percent of population 25+ with Bachelor's degree and above: " + 
...
//This function passes the google chart info to the drawEducationChart function and runs the function
function init() {
