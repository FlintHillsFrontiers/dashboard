      ...
      <div class="row">
	    ...
	    <h4><i class="fa fa-tachometer"></i>Dashboard</h4><hr>
          <ul class="nav nav-sidebar">
            ...
            <li><a href="dashboard-economy.php"><i class="fa fa-usd"></i>Economy</a></li>
            <li><a href="dashboard-built.php"><i class="fa fa-home"></i>Built Environment</a></li>
            <li><a href="dashboard-farm.php"> <span class="glyphicon glyphicon-grain" aria-hidden="true"></span>Farm & Ranch</a></li>
            <li><a href="dashboard-social.php"><i class='fa fa-smile-o'></i>Social Systems</a></li>
          </ul>
